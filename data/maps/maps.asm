...
; pointers to the first map of each map group
	...
	dw MapGroup_TransferNetwork ; 27
...
MapGroup_FastShip:
	...
	map VermilionPort, TILESET_PORT_TRUCK, ROUTE, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_TransferNetwork:
	table_width MAP_LENGTH
	map TransferNetworkEntry, TILESET_FACILITY, INDOOR, LANDMARK_ROUTE_25, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map TransferNetworkBlockade, TILESET_FACILITY, INDOOR, LANDMARK_ROUTE_25, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map TransferNetworkDeepNode, TILESET_FACILITY, INDOOR, LANDMARK_ROUTE_25, MUSIC_NONE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	assert_table_length NUM_TRANSFER_NETWORK_MAPS
